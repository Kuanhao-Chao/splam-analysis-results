...
def main():
    ...
    MODEL_OUTPUT_BASE = "/ccb/cybertron/khchao/splam-analysis-results/results/eval_test_chromosome/splam/predict_out/splam/"
    ...
    print(" Model: ", model)
    print("########################################")
    test_f = f'{project_root}results/eval_test_chromosome/splam/splam.juncs.seq.fa'
    os.makedirs(MODEL_OUTPUT_BASE, exist_ok=True)
    d_score_tsv_f = MODEL_OUTPUT_BASE+"/splam_all_seq.score.d.tsv"
    a_score_tsv_f = MODEL_OUTPUT_BASE+"/splam_all_seq.score.a.tsv"
    name_tsv_f = MODEL_OUTPUT_BASE+"/splam_all_seq.name.tsv"
    d_score_fw = open(d_score_tsv_f, "a")
    a_score_fw = open(a_score_tsv_f, "a")
    # name_fw = open(name_tsv_f, "a")

    test_loader = get_eval_dataloader(BATCH_SIZE, MODEL_VERSION, N_WORKERS, True, test_f)
    ...
    # with open(MODEL_OUTPUT_BASE + "/splam." + target + ".pkl", 'wb') as f:
    ...
    # with open(MODEL_OUTPUT_BASE + "/splam.da." + target + ".pkl", 'wb') as f:
