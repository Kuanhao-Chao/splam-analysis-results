...
output_dir = f'{project_root}results/eval_test_chromosome/splam/'
...
def main():
    ...
    for output_file in output_files:
        ...
        fw = open(f'{output_file}splam.juncs.seq.fa', "w")
        fr_donor = open(f'{output_file}splam.juncs.donor.seq.fa', "r")
        fr_acceptor = open(f'{output_file}splam.juncs.acceptor.seq.fa', "r")
