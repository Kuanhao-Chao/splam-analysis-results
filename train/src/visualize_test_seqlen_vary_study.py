...
albation_study_root=f'{project_root}train/src/MODEL_TEST/'
...
def visualize_test_seqlen_vary_study(window_size):
...
for eval_target in ['A', 'D', 'J']:
    ...
    for window_size in [5, 20, 40, 80]:
        visualize_test_seqlen_vary_study(window_size)