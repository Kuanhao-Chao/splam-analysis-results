...
input_file_dir = f'{project_root}train/results/BAM_TEST_junctions/'
...
def main():
    ...
    fw = open(f'{output_dir}{SEQ_LEN}bp/input_test.fa', "w")
    fr_donor = open(f'{input_file_dir}{SEQ_LEN}bp/donor_seq.fa', "r")
    fr_acceptor = open(f'{input_file_dir}{SEQ_LEN}bp/acceptor_seq.fa', "r")
