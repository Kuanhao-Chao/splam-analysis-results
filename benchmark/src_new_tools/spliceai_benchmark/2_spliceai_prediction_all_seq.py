...
def main(argv):
    ...
    ##################################################
    input_dir = f'../results/spliceai/1/'
    output_dir = f'../results/spliceai/2/v{spliceai_version}/'
    path = f'./spliceai_models/spliceai{spliceai_version}.h5'
    ...
    d_score_tsv_f = f'{output_dir}spliceai_all_seq.score.d.{TYPE}.tsv'
    a_score_tsv_f = f'{output_dir}spliceai_all_seq.score.a.{TYPE}.tsv'
    n_score_tsv_f = f'{output_dir}spliceai_all_seq.score.n.{TYPE}.tsv'
    name_tsv_f = f'{output_dir}spliceai_all_seq.name.{TYPE}.tsv'
